...
module Clockwork
  module Holidays
    module Australia
      ...
      AUSTRALIA_DAY = Clockwork{|x| c.january & c.mday(26)}
      ...
      ANZAC_DAY = Clockwork{|x| c.april & c.mday(25)}
      ...
      BOXING_DAY_EXCEPT_SOUTH_AUSTRALIA = Clockwork{|x| c.december & c.mday(26)}
      PROCLAMATION_DAY_SOUTH_AUSTRALIA_ONLY = Clockwork{|x| c.december & c.mday(26)}
