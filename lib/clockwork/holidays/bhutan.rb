...
module Clockwork
  module Holidays
    module Bhutan
      ...
      THE_KINGS_BIRTHDAY = Clockwork{|x| c.may & c.mday(2)}
      #(lunar) - Shabdrung Kuchoe (death anniversary of the Shabdrung)
      #(lunar) - Third King's Birthday
      CORONATION_DAY = Clockwork{|x| c.june & c.mday(2)}
      ...
      NATIONAL_DAY = Clockwork{|x| c.december & c.mday(17)}
      WINTER_SOLSTICE = Clockwork{|x| c.december & c.mday(21)}
